window.PART_DATA_5 = {
  title: "The Great Indoors: At Home in the Modern British House",
  instructions:
    "You are going to read an article about human memory and cognition. For questions 31–36, choose the answer (A, B, C or D) which you think fits best according to the text.",
  articleTitle: "The Great Indoors: At Home in the Modern British House",
  passage: `
    <p style="margin-bottom: 15px;">
      In 1910 the music hall comedian Billy Williams scored his biggest hit with the song <i>When Father Papered the Parlour</i>, mocking the incompetence of the amateur home decorator. Fifty years later, comedians Norman Wisdom and Bruce Forsyth were still entertaining millions on the TV show <i>Sunday Night</i> at the London Palladium with a similar routine, but the joke was starting to look dated. The success of magazines such as <i>The Practical Householder</i> was already proving that, as the 1957 <i>Ideal Home Exhibition</i> proclaimed, “Do-it-yourself is a home hobby that is here to stay.”
    </p>
  ...
  questions: [
    ...
    {
      number: 32,
      prompt: "In the second paragraph, the reviewer says that the book includes evidence illustrating",
      options: [
    ...
    {
      number: 33,
      prompt: "In the third paragraph, the reviewer points to a change in",
      options: [
    ...
    {
      number: 34,
      prompt: "The reviewer suggests in the fourth paragraph that",
      options: [
    ...
    },
    {
      number: 35,
      prompt:
        "In the fifth paragraph, the reviewer says that in his book, Highmore",
      options: [
    ...
    {
      number: 36,
      prompt: "In the final paragraph, the reviewer suggests that Highmore may be wrong about",
      options: [
